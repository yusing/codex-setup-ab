...
async function executeBenchmark(options: RunOptions, mode: "run" | "finish"): Promise<void> {
...
export function runBenchmark(options: RunOptions): Promise<void> {
  return executeBenchmark(options, "run");
}

export function finishBenchmark(options: RunOptions): Promise<void> {
  return executeBenchmark(options, "finish");
}
